...
/* Raster Imaging */
#define PCL_OP_BEGIN_IMAGE         0xC8
#define PCL_OP_READ_IMAGE          0xC9
#define PCL_OP_END_IMAGE           0xCA

#define PCL_OP_BEGIN_SCAN          0xE4
#define PCL_OP_SCANLINE_REL        0xE5
#define PCL_OP_END_SCAN            0xE6
...
/* Attribute IDs				 */
/* ============================= */
#define PCL_ATTR_MEASURE			0x0A
#define PCL_ATTR_UNITS_PER_MEASURE	0x0B
#define PCL_ATTR_MEDIA_SIZE			0x1E
#define PCL_ATTR_ORIENTATION		0x1F
#define PCL_ATTR_SOURCE_WIDTH		0x42
#define PCL_ATTR_SOURCE_HEIGHT		0x43
#define PCL_ATTR_COLOR_SPACE		0x5C
#define PCL_ATTR_BITS_PER_PIXEL		0x4F
#define PCL_ATTR_COMPRESSION		0x6D
#define PCL_ATTR_ROP3				0x7A
